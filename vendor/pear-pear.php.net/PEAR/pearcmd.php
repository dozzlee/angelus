...
if ('/var/www/laravel/vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/var/www/laravel/vendor/pear-pear.php.net/PEAR '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
