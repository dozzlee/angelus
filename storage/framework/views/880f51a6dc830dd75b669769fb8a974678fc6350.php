        ...
        <div id="loginbox" style="margin-top:50px;" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-default" >
                ...
                <div style="padding-top:30px" class="panel-body" >
                    ...
                    <form method="POST" action="<?php echo e(route('login-user')); ?>" class="form-horizontal" role="form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div style="margin-top:10px" class="form-group">
                            <div class="col-sm-12 controls">
                                <button type="submit" id="btn-login" href="#" class="btn btn-success accent-bg-5" style="float:right; margin-top:8px;"> Login  </button>
                            </div>
                        </div>
