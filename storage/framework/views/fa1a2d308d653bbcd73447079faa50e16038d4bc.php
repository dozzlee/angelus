                        ...
                        <div class="vert-center">
                            <nav class="header-auth-nav" role="navigation">
                                <ul class="nav nav-pills navbar-nav">
                                  ...
                                  <?php else: ?>
                                    <li role="presentation" class="dropdown has-panel">
                                      <p style="padding-top:10px; text-transform:capitalize;">Welcome, <?php echo e(Auth::user()->first_name); ?> </p>
                                    </li>
                                  <?php endif; ?>
                                </ul>
                            </nav>
                        ...
                        <div class="btn-wrapper dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php if(Auth::user()): ?>
                                  ...
                                  <?php endif; ?>
                                  <li><a href="<?php echo e(route('logout-user')); ?>">Logout</a></li>
                                <?php endif; ?>
                            </ul>
                            <!-- /Dropdown Menu -->
                                    ...
                                    <ul class="mini-cart">
                                        ...
                                        <?php if(Auth::user()): ?>
                                          <?php if($cart): ?>
                                            ...
                                            <li class="clearfix">
                                                <img src="<?php echo e($cartItem->product->imageurl); ?>" alt="">
                                                <div class="text">
                                                    <a class="title" href="#"><?php echo e($cartItem->product->name); ?></a>
                                                    <div class="details"><?php echo e($cartItem->quantity); ?> x $<?php echo e(number_format($cartItem->product->price,2,'.','')); ?>

                                                        <div class="btn-group">
                                                            <a class="btn accent-0 accent-bg-2" href="/cart"><i class="ti ti-pencil"></i></a>
                                                            <a class="btn btn-default" href="/carts/<?php echo e($cartItem->id); ?>/delete"><i class="ti ti-trash"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php endforeach; ?>
                                            <p style="text-align:right; margin:-10px 0px; color:#222; padding:0px;">Cart Total: $<?php echo e(number_format($total,2,'.','')); ?></p>
                                          <?php else: ?>
